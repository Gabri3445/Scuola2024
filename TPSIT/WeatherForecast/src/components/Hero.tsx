const Hero = ({children}: any) => {
    return (
        <>
            <div className="w-full h-screen flex justify-center bg-no-repeat flex-col bg-cover bg-[url('https://images.pexels.com/photos/557782/pexels-photo-557782.jpeg')]">
